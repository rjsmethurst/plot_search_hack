...
(function () {
  ...
  var ea = function ea(a) {
    ...
    za = function za(a, b) {
      ...
      for (var c = {}, d = Math.min(a.length + 1, b.length), e = 0; e < d; e++) if ("object" === _typeof(b[e])) {
  ...
  Ya.prototype.set = function (a, b, c) {
    if (a) if ("object" === _typeof(a)) for (var d in a) a.hasOwnProperty(d) && ab(this, d, a[d], c);else ab(this, a, b, c);
  };
  ...
  function mf(a, b) {
    if (a) if ("object" === _typeof(a)) for (var c in a) a.hasOwnProperty(c) && hf(c, b);else hf(a, b);
  }
  ;
  var ue = new ee(),
    ve = [],
